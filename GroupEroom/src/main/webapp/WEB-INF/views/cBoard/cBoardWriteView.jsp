			...
			<div class="row">
				<div class="col-md-12">
					<div class="content-panel">
						...
						<br>
						<form action="cBoardRegister.do" method="post" enctype="multipart/form-data">
						<input type="hidden" value="${LoginUser.memberId}" name="memberId">
							    <div class="form-group">
							      <label class="form-label mt-4">제목</label>
							      <textarea class="form-control" id="title" rows="1" name="cBoardTitle"></textarea>
							    </div>
						
							    <div class="form-group">
							      <label class="form-label mt-4">내용</label>
							      <textarea id="summernote" name="cBoardContents"></textarea>
							    </div>
							    <div>
